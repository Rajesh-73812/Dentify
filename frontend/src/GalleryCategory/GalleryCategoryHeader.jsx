...
const GalleryCategoryHeader =  ({ onSearch }) => {
  return (
    <div>
        <div className="bg-[#f7fbff] p-6 w-[1000px]">
            <div className=" flex items-center justify-between h-9" style={{ height: "36px" }}>
                <div className="flex items-center mt-6  mb-4">
                    ...
                    <h2 className="text-lg font-semibold ml-4 " style={{color:'#000000',fontSize:'24px',fontFamily:'Montserrat'}}>Gallery Category Management System</h2>
                </div>
...
export default GalleryCategoryHeader