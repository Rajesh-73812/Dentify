            ...
            <div className=" flex items-center justify-between" style={{ height: "36px" }}>
                ...
                <div className=' flex items-center gap-3'>
                    ...
                    <div className=" text-left flex gap-3">
                        ...
                        <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" onClick={navigateToAddService} style={{ height: "36px" }}> <AddRoundedIcon style={{ fontSize: "18px", marginTop: "2px" }} /> Create Service </button>
                    </div>
                </div>
            </div>
        </div>
