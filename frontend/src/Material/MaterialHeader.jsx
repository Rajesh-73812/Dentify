    ...
    return (
        <div className="bg-[#f7fbff] p-6 w-[1000px]">
            <div className=" flex items-center justify-between h-9" >
                <div className=" sm:text-2xl w-16 h-9 whitespace-nowrap text-[#131313] font-[Montserrat] text-xl font-semibold">
                    Materials List
                </div>
                <div className=' flex items-center gap-3'>
                    ...
                    <div className=" text-left flex gap-3">
                        <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 h-9" type="button" onClick={navigateToAddMaterial} > <AddRoundedIcon  className='font-[18px] mt-[2px]'/> Create Material </button>
                    </div>
                </div>
            </div>
        </div>
