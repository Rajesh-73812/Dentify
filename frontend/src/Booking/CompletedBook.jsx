                                    ...
                                    <thead className="bg-gray-50 text-xs uppercase font-medium text-gray-500">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 min-w-[250px]">
                                              User Rating
                                                <div className="inline-flex items-center ml-2">
                                                    <GoArrowUp onClick={() => handleSort('rating')} />
                                                    <GoArrowDown onClick={() => handleSort('rating')} />
                                                </div>
                                            </th>
                                            <th className="px-4 py-3 min-w-[250px]">
                                              User Feedback
                                                <div className="inline-flex items-center ml-2">
                                                    <GoArrowUp onClick={() => handleSort('feedback')} />
                                                    <GoArrowDown onClick={() => handleSort('feedback')} />
                                                </div>
                                            </th>
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {currentCountries.map((country, index) => (
                                            <tr key={country.id}>
                                                ...
                                                <td className="px-4 py-3"> {"No Rating Provide"}</td>
                                                <td className="px-4 py-3"> {"No FeedBack Provide"}</td>
                                                <td className="px-4 py-3">
