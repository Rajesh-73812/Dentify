                                        ...
                                        {currentCountries.map((country, index) => (
                                            <tr key={country.id}>
                                                ...
                                                <td className="px-4 py-3">
                                                    ...
                                                    <span className=' px-3 py-1 text-sm rounded-full bg-cyan-400 cursor-pointer text-white' onClick={navigateApprove}>Confirmed</span>
                                                    <span className='px-3 py-1 text-sm rounded-full bg-red-400 cursor-pointer text-white' onClick={openModal2}>Cancelled</span>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
