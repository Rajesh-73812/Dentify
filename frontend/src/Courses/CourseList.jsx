...
import { Box, Container, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Pagination, TextField, Button, InputAdornment, Card, CardContent } from '@mui/material';
                  ...
                  <Table>
                    <TableHead >
                      <TableRow>
                        ...
                        <TableCell sx={{ color:'#131313' }}>Course Name</TableCell>
                        <TableCell sx={{ color:'#131313' }}>Course Type</TableCell>
                        <TableCell sx={{ color:'#131313' }}>Course Source</TableCell>
                        <TableCell sx={{ color:'#131313' }}>Course Changes</TableCell>
                        <TableCell sx={{ color:'#131313' }}>From Date</TableCell>
                        <TableCell sx={{ fcolor:'#131313' }}>To Date</TableCell>
                    ...
                    <TableBody>
                      {rows.map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell sx={{color:'#4D5D6B'}}>{row.courseType}</TableCell>
                          <TableCell sx={{color:'#4D5D6B'}}>{row.courseSource}</TableCell>
                          <TableCell sx={{color:'#4D5D6B'}}>{row.courseChanges}</TableCell>
