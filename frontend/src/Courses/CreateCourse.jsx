              ...
              <form className="mt-4">
                ...
                <div className="grid gap-4 w-full sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-6">
                  ...
                  <div className="flex flex-col">
                      <label  htmlFor="name_of_opportunity"  className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Course Name </label>
                  ...
                  <div className="flex flex-col relative">
                    <label   htmlFor="form_date"   className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Course Start Date </label>
                    ...
                    {/* course end  date */}
                  <div className="flex flex-col relative">
                    <label   htmlFor="to_date"   className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Course End Date </label>
                      <div className="relative mt-1">
                  ...
                  {/* course type  */}
                  <div className="flex flex-col">
                    <label htmlFor="course_type" className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Course Type </label>
                    <div className="flex mt-1">
                      <div className="flex items-center mr-4">
                        ...
                        <label htmlFor="online" className="ml-2 text-sm font-medium font-[Montserrat]">
                          Online
                        </label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="in-person" className="ml-2 text-sm font-medium font-[Montserrat]">
                          In-Person
                        </label>
                      </div>
                    </div>
                ...
                <div className="grid gap-4 w-full sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-6">
                   ...
                   <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-x-1 mt-1">
                      ...
                      <div className="flex items-center">
                        ...
                        <label  htmlFor="paid"  className="ml-2 text-sm font-medium font-[Montserrat]">Paid</label>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <label  htmlFor="free"  className="ml-2 text-sm font-medium font-[Montserrat]">Free</label>
                      </div>
                  ...
                  {/* Amount */}
                  <div className="flex flex-col">
                    <label  htmlFor="amount"  className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Amount</label>
                  ...
                  {/* Description */}
                  <div className="flex flex-col">
                    <label  htmlFor="description"  className="text-sm font-medium text-start text-[12px] font-[Montserrat]">Description</label>
                ...
                <div className="flex justify-end mt-6 gap-3">
                  ...
                  <button  type="submit"  className="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue- w-[150px] h-12 font-[Montserrat]"  style={{borderRadius:"8px"}}>
                    Save
                  </button>
                </div>
              </form>
