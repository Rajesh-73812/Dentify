                  ...
                  <Table>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell sx={{color:'#131313'}}>Product Name</TableCell>
                        <TableCell sx={{color:'#131313'}}>Product Category</TableCell>
                        <TableCell sx={{color:'#131313'}}>Product Source</TableCell>
                        <TableCell sx={{color:'#131313'}}>Product Price</TableCell>
                    ...
                    <TableBody>
                      {rows.map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell sx={{color:'#4D5D6B'}}>{row.source}</TableCell>
                          <TableCell sx={{color:'#4D5D6B'}}>{row.price}</TableCell>
