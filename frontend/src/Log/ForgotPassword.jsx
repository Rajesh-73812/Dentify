    ...
    <div className="h-screen grid grid-cols-2"> 
        ...
        <div className="flex items-center justify-center bg-white p-6"> 
            <div className="w-full max-w-md bg-white rounded-xl p-8"
                ...
                <h2 className='font-bold text-[24px] leading-[36px] sm:text-[28px] sm:leading-[44px] md:text-[36px] md:leading-[56px] lg:text-[40px] lg-leading[64px] float-left font-[poppins]' >Welcome Back</h2>
                ...
                <form className="space-y-4">
                    ...
                    <div className='flex relative'>
                        <input type="password" id="password" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#439BFF] placeholder:font-[poppins] placeholder:text-[14px] placeholder:text-[#25064C]"  placeholder="Password"/> <span className='mt-2 cursor-pointer visibilityIcon' style={{position:"absolute",right:"16px"}} ><VisibilityOffOutlinedIcon fontSize='30px' /></span> 
                    </div>
